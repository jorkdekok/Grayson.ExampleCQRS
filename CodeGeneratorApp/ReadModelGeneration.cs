...
{
    public static class ReadModelGeneration
    {
        public static SyntaxNode GenerateViewModel(SyntaxNode node)
        {
            ...
            if (classNode != null)
            {
                ...
                string viewModelClassName = $"{modelClassName}View";
                // Only for demo purposes, pluralizing an object is done by simply adding the "s"
                // letter. Consider proper algorithms
